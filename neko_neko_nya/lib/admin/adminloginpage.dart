// lib/auth/admin_login.dart

import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import '../login_dashboard/login_dashboard.dart';
import 'admin_dashboard.dart'; // Adjust the path as necessary
  ...
  Future<void> _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        // Check if the user does NOT exist in the Firestore 'Users' collection
        ...
        if (!userDoc.exists) {
          ...
          // If user document exists, sign out and show error
          await _auth.signOut();
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // Top Center Image
                Image.asset(
                  'assets/adminl.png', // Ensure you have this image in your assets
